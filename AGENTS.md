...
**Toolchain:** use installed `chitra <capabilities|intake|decompose|compare|plan|board|conform|creative-check|review-validate|review-score|review-calibrate|validate|check|render|evidence|release|verify-release|probe>`. Repository development may use `node core/dist/cli/index.js`. Requires FFmpeg and a system Chromium-family browser.
