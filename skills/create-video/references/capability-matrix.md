...
| Native Frame System and staged specialist handoffs | yes | — | Free/stack/grid, bounded type treatments, and declared rendered spatial contracts; no automatic taste guarantee or general constraint solver. |
