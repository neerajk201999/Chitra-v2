...
export { TRANSCRIPT_VERSION, EDIT_VERSION, EDIT_RECEIPT_VERSION, TranscriptDraft, LockedTranscript, EditDecisionList, validateTranscript, validateEditDecisionList, lockTranscript, transcriptDigest, packTranscript, resolveEdit, verifyTranscriptSources, resolveEditArtifactTarget, renderEdit, type TranscriptDraftT, type LockedTranscriptT, type EditDecisionListT, type ResolvedEditSegment, type EditRenderReceipt } from "./editing/index.js";
