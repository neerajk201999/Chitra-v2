...
- **A-10 (partly closed, M3/M5) Expressiveness ceiling.** The original review found 14 presets, no keyframes, masks, video-in-scene, nested composition, or per-character type. Video, figures, type-in, particles, real 3D primitives, and reason-gated typed frame tracks have since shipped (ADR-0007…0013). Masks/mattes, nested compositions, blend modes, motion blur, internal 3D tracks, and chart breadth remain open; the quality floor is preserved by MO-KEY-1 rather than an untyped raw-value escape hatch.
