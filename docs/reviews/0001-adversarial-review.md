...
- **A-10 (partly closed, M3/M5) Expressiveness ceiling.** The original review found 14 presets, no keyframes, masks, video-in-scene, nested composition, or per-character type. Video, figures, type-in, particles, real 3D primitives, reason-gated DOM tracks, and typed textured internal 3D tracks have since shipped (ADR-0007…0013, ADR-0028). Masks/mattes, nested compositions, blend modes, motion blur, and chart breadth remain open; the quality floor is preserved by MO-KEY-1/MO-3D-2 rather than an untyped raw-value escape hatch.
